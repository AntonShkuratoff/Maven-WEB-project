...
<body>
	...
	<br />
	<form action="Controller" method="post">
		<input type="hidden" name="command" value="REGISTRAITION_NEW_USER" />
		<fieldset>
			...
			<fieldset>
				...
				<label><input type="text" name="name" value="${name}" required
					pattern="[А-Яа-яЁё]{2,25}" maxlength="25"></label><br> <label><input
					type="text" name="patronymic" value="${patronymic}" required
					pattern="[А-Яа-яЁё]{2,25}" maxlength="25"></label><br>
			</fieldset>
